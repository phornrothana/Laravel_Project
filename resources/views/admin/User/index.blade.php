          ...
          <div class="row">
            <div class="col-4">
                <a href="{{ route('admin.user.create') }}" class="btn btn-outline-primary btn-icon-text">
                    <i class="btn-icon-prepend">Create User</i>
                </a>
            </div>
            <div class="col-4">
                ...
                <tr>
                 ...
                 <td>
                    @if($item->profile_image)
                        <img src="{{ asset('backend/upload/admin_image/' . $item->profile_image) }}" alt="User Image" />

                    @else
                        <img src="{{ asset('backend/upload/no_image.jpg') }}" alt="No Image" />
                 ...
                 <td>
                   <a href="{{ route('admin.user.edit',@$item->id) }}" class="btn btn-outline-secondary btn-icon-text">
